...
for method in options.method:
   for basis in options.basis:
      ...
      if options.almo:
         ...
         qrems.ModRem('ALMO_EFIELD', 'TRUE', myrems_1)
      else:
         ...
         qrems.ModRem('EMBEDDING_EARLY_STOP', 'TRUE', myrems_1)
      ...
      if options.almo:
         ...
         qrems.ModRem('ALMO_EFIELD', 'TRUE', myrems_2)
      else:
      ...
      for xyz_file in xyzfile_list:
         ...
         if options.almo:
            ...
            inputfile = input_path+parsed_XYZ.Name+'_spade_'+method+'_'+qrems.basis_abbr(basis)+'.in' 
         fw = open(inputfile, 'w')
